...
> Tip: leave the field empty and use the **Launch Emulator** command — VS Code
> will prompt you with a file picker the first time, then remember the choice.
